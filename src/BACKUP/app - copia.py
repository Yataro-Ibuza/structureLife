...
class Structure(db.Model):
    ...
    stru_comp_id = db.Column(db.Integer, db.ForeignKey(
        'Company.comp_id'), nullable=False)
...
class Zone(db.Model):
    ...
    # Sublevel - data
    zone_bend = db.Column(db.Integer, nullable=False)
    zone_temperature = db.Column(
        db.Integer, nullable=False)    # Sublevel - data

    zone_stru_id = db.Column(db.Integer, db.ForeignKey(
        'Structure.stru_id'), nullable=False)
